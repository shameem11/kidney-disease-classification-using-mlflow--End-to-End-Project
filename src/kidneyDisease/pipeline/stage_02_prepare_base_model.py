...
class PrepareBaseModelTrainingPipeline:
    ...
    def main(self):
        ...
        # Optional: Log the model summary again after unfreezing layers for tracking
        ...
        # Optionally,  can log some additional metrics if needed, like learning rate schedule or training performance
